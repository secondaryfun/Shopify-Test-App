...
var Day = /*#__PURE__*/React.memo(function Day({
  ...
  if (!day) {
    return /*#__PURE__*/React__default.createElement("td", {
      className: styles$K.EmptyDayCell,
  ...
  var dayCellClassName = classNames(styles$K.DayCell, selected && styles$K['DayCell-selected'], (inRange || inHoveringRange) && !disabled && styles$K['DayCell-inRange'], isLastSelectedDay && styles$K['DayCell-lastInRange'], isFirstSelectedDay && styles$K['DayCell-firstInRange'], isHoveringRight && styles$K['DayCell-hoverRight'], rangeIsDifferent && styles$K['DayCell-hasRange']);
  var dayClassName = classNames(styles$K.Day, selected && styles$K['Day-selected'], disabled && styles$K['Day-disabled'], today && styles$K['Day-today'], (inRange || inHoveringRange) && !disabled && styles$K['Day-inRange'], isLastSelectedDay && styles$K['Day-lastInRange'], isFirstSelectedDay && styles$K['Day-firstInRange'], isHoveringRight && styles$K['Day-hoverRight'], rangeIsDifferent && styles$K['Day-hasRange']);
