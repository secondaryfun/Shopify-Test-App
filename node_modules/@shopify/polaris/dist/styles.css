:root{ --polaris-version-number:'5.4.0'; --polaris-animation-skeleton-shimmer:polaris-SkeletonShimmerAnimation; }
...
.Polaris-DatePicker__Month{ flex:1 1 23rem; margin-top:1.6rem; margin-left:1.6rem; max-width:calc(100% - 1.6rem); min-width:23rem; table-layout:fixed; border-collapse:collapse; border:none; border-spacing:0; }
...
.Polaris-Tag{ display:inline-flex; max-width:100%; align-items:center; min-height:2.8rem; padding:0 0.8rem; background-color:var(--p-background, #dfe3e8); border-radius:3px; color:var(--p-text, #212b36); }
...
.Polaris-Frame__SkipAnchor.Polaris-Frame--newDesignLanguage.Polaris-Frame--pressed svg{ fill:currentColor; }
...
.Polaris-ProgressBar{ overflow:hidden; width:100%; background-color:var(--p-action-secondary, #dfe3e8); border-radius:var(--p-border-radius-base, 3px); }
...
.Polaris-ResourceList-CheckableButton.Polaris-ResourceList-CheckableButton--newDesignLanguage{ background:var(--p-surface); box-shadow:var(--p-button-drop-shadow); border:1px solid var(--p-border-neutral-subdued); border-top-color:var(--p-border-subdued); border-bottom-color:var(--p-border-shadow-subdued); }
...
.Polaris-ResourceList-BulkActions--disabled.Polaris-ResourceList-BulkActions--newDesignLanguage{ box-shadow:none; border-color:var(--p-border-disabled); background:var(--p-surface-disabled); color:var(--p-text-disabled); }
